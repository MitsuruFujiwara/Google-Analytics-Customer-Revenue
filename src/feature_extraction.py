...
def main(nrows=None):
    ...
    test.to_csv('../input/extracted_fields_test.gz', compression='gzip', index=False)
    train.to_csv('../input/extracted_fields_train.gz', compression='gzip', index=False)
...
def get_logger():
    ...
    fh = logging.FileHandler('../output/logging.log')
